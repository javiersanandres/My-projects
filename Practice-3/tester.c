...
int main(int argc, char *argv[]) 
{
    ...
    /* Start testing */
    /* ccomment this test if you find the function
     * repalceExtensionByIdx() unuseful and you don't want to
     * implement it*/
    ...
    /*CAREFUL, ONLY CHECKS THE INDEXFILE WIT NO REGARD TO THE FREE GAPS AND THEIR OFFSETS FROM DATA FILE*/
    checkAddIndexEntry(indexName);
    
    /*THIS DOES TAKE INTO ACCOUNT BOTH FILES, SINCE addTableEntry calls AddIndexEntry*/
    
    createTestFiles(tableName, indexName);
    checkAddTableEntry(tableName, indexName, stop);
